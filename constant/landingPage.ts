...
import { BadgeCheckIcon, BicepsFlexed, HandshakeIcon, ShieldCheckIcon } from "lucide-react";
...
export const howItWorksList: HowItWorksType[] = [
    {
        title: 'Online Order',
        description: 'Order what you need from our website at your convenience, and within seconds, all your food supplies will be prepared and ready to fuel your day.',
        image: '/images/landing/how_it_works/online_order.png'
    },
    {
        title: 'Freshly Delivery',
        description: 'Our experienced drivers, familiar with local routes, handle deliveries with care, ensuring the freshness and quality of your items every step of the way.',
