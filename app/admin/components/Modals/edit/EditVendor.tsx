import { AlertColor, Box, Button, Divider, Modal, TextField, Typography } from '@mui/material'
            ...
            <Box display="flex" flexDirection="column" gap={3}>
              ...
              <Box display="flex" flexDirection="column" gap={1}>
                ...
                <TextField 
                  ...
                  onChange={(e) => setUpdatedVendor({ ...updatedVendor, phoneNumber: e.target.value })}
                />
              </Box>
              ...
              <Box display="flex" flexDirection="column" gap={1}>
                ...
                <AutoCompleteAddress onDataReceived={(data) => setAddress(data?.description)} initialValue={vendor.address}/>
              </Box>
