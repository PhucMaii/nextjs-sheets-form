...
export default function DeliveryProofOrInvoice({
  file,
  handleViewFile,
  handleDownloadFile,
  isSelected = false,
  ...
  const accentColor = label === 'Delivery Proof' ? success.main : primary.main;
  const bgColor =
    label === 'Delivery Proof' ? success.lightest : primary.lightest;
        ...
        <Chip
          ...
          icon={
            label === 'Delivery Proof' ? (
              <LocalShippingIcon sx={{ fontSize: 14, fill: 'white' }} />
            ) : (
              <ReceiptIcon sx={{ fontSize: 14, fill: 'white' }} />
            )
          }
        />
          ...
          <>
            ...
            <Stack spacing={1}>
              ...
              >
                ...
                <Typography variant="body2" sx={{ color: neutral[700] }}>
                  {file.delivery.deliveredAt
                    ? dayjs(file.delivery.deliveredAt).format(
                        'MMM DD, YYYY HH:mm',
                      )
                    : 'No record'}
                </Typography>
