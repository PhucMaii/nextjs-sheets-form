...
import { FolderCopy as FolderCopyIcon, CalendarToday as CalendarTodayIcon } from '@mui/icons-material';
...
export default function SmallBundleProgramCard({
	...
	const uniqueDays = new Set(bundleProgram.dayPrograms.map(dp => dp.day)).size;
