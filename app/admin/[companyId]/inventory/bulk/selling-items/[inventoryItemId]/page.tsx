...
import BulkEditOptions from '@/app/admin/[companyId]/components/Bulk/BulkEditOptions';
import AddOption from '@/app/admin/[companyId]/components/Modals/add/AddOption';
import AddItem from '@/app/admin/[companyId]/components/Modals/add/AddItem';
...
export default function BulkEditItems() {
  const { inventoryItemId, companyId }: any = useParams();
  ...
  const fetchItems = async () => {
    try {
      const response = await axios.get(
        getAdminApiUrl(companyId, `/items?inventoryItemId=${inventoryItemId}`),
      );
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        getAdminApiUrl(companyId, '/bulk/selling-items'),
        {
          items: selectedItems,
        },
      );
