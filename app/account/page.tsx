...
export default function AccountPage() {
    ...
    const checkPasswordInput = () => {
        if (!passwordGroup.oldPassword || !passwordGroup.newPassword || !passwordGroup.confirmPassword) {
            return { isValid: false, message: 'All password fields need to be filled out' }
        }
            ...
            <ShadowSection display="flex" flexDirection="column" gap={2} mt={2}>
                ...
                <Box display="flex" flexDirection="column" gap={1}>
                    ...
                    <OutlinedInput
                        ...
                        onChange={(e) => { handleChangePasswordGroup('oldPassword', e.target.value) }}
                ...
                <Box display="flex" flexDirection="column" gap={1}>
                    ...
                    <OutlinedInput
                        ...
                        onChange={(e) => { handleChangePasswordGroup('newPassword', e.target.value) }}
                ...
                <Box display="flex" flexDirection="column" gap={1}>
                    ...
                    <OutlinedInput
                        ...
                        onChange={(e) => { handleChangePasswordGroup('confirmPassword', e.target.value) }}
